"""
Train model on multi-tissue data with gene symbols.
"""
import pandas as pd
import numpy as np
...
print("=" * 70)
print("🧬 TRAINING MULTI-TISSUE MODEL (WITH SYMBOLS)")
print("=" * 70)

# Load data
df = pd.read_csv('../02_Features/processed/multi_tissue_matrix_symbols.csv.gz', compression='gzip')
...
print("\n" + "=" * 70)
print("📊 MULTI-TISSUE MODEL (SYMBOLS) PERFORMANCE")
print("=" * 70)
...
joblib.dump(model, 'processed/multi_tissue_symbols_model.pkl')
...
with open('processed/multi_tissue_symbols_metrics.json', 'w') as f:
    json.dump(metrics, f, indent=2)

print("\n💾 Model saved: processed/multi_tissue_symbols_model.pkl")
