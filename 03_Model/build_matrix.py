...
def main(input_path: str = "../02_Features/processed/training_matrix_chr22.txt.gz", 
         output_dir: str = "processed") -> None:
    ...
    with open(f"{output_dir}/feature_matrix_summary.json", "w") as f:
